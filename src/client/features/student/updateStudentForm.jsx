...
export default function UpdateForm({ id }) {
  ...
  const update = async (evt) => {
    evt.preventDefault();
    updateStudent({ id, firstName, lastName, email, imageUrl, gpa });
  };
  return (
    <section>
      <form onSubmit={update}>
        ...
        <label className="update-last-name">
          Last Name
          <input
            type="text"
            value={lastName}
        ...
        <label className="update-imageUrl">
          link to submit a student photo
          <input
            type="text"
            value={imageUrl}
